...
export function AvailabilityManager({
  ...
  // Local state keeps the list in sync without waiting for server re-render
  ...
  async function handleBlock(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/availability", {
        ...
        body: JSON.stringify({ artistId, date, startTime }),
      });
      ...
      if (!res.ok) {
        ...
        // Prepend the new block immediately for instant feedback
        if (data.block) {
